...
SYSTEM_PROMPT = (
    ...
    "'points' for sized/colored markers, or 'regions' for a choropleth heat map that "
    "shades district polygons by value. Places are district ids (AZ-01) or state "
    "codes. Use for anything the district money-map cannot show, e.g. a whole state "
    "as a funding heat map, or candidates colored by party. Gather the values with "
    "state_field or the funding tools first.\n\n"
