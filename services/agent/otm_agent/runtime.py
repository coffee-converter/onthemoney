...
SYSTEM_PROMPT = (
    ...
    "- rank_districts(order, limit): rank districts nationwide by their leading "
    "candidate's itemized receipts, order 'asc' (least-funded first) or 'desc' "
    "(best-funded first). Use for 'which district has the least/most funding' or "
    "'lowest/highest-funded districts' - do NOT eyeball this off map_nation; this "
    "returns each district's state and number directly.\n"
