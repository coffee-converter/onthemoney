...
SYSTEM_PROMPT = (
    ...
    "state's House districts - a 'regions' choropleth or 'points' bubbles, colored by "
    "'party' or 'money', optionally 'label'ed with district numbers. Prefer this for "
    "any 'show/map <state>' request.\n"
